...
const (
	...
	SQL_DESC_TABLE_NAME    = C.SQL_DESC_TABLE_NAME
	SQL_DESC_LABEL         = C.SQL_DESC_LABEL

	SQL_DESC_BASE_TABLE_NAME = C.SQL_DESC_BASE_TABLE_NAME
	SQL_DESC_SCHEMA_NAME     = C.SQL_DESC_SCHEMA_NAME
	...
	SQL_CURSOR_STATIC    = C.SQL_CURSOR_STATIC

	SQL_ATTR_CURSOR_SCROLLABLE = C.SQL_ATTR_CURSOR_SCROLLABLE
	SQL_NONSCROLLABLE          = C.SQL_NONSCROLLABLE
	SQL_SCROLLABLE             = C.SQL_SCROLLABLE

	SQL_ATTR_ROW_ARRAY_SIZE = C.SQL_ATTR_ROW_ARRAY_SIZE

	SQL_ATTR_CURSOR_SENSITIVITY = C.SQL_ATTR_CURSOR_SENSITIVITY
	SQL_UNSPECIFIED             = C.SQL_UNSPECIFIED
	SQL_INSENSITIVE             = C.SQL_INSENSITIVE

	SQL_SENSITIVE = C.SQL_SENSITIVE

	SQL_FETCH_ABSOLUTE = C.SQL_FETCH_ABSOLUTE

	SQL_LOCK_NO_CHANGE = C.SQL_LOCK_NO_CHANGE
	SQL_LOCK_EXCLUSIVE = C.SQL_LOCK_EXCLUSIVE
	SQL_LOCK_UNLOCK    = C.SQL_LOCK_UNLOCK
